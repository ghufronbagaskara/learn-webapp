...
export function ProductDeleteModal({ product, onClose }: ProductDeleteModalProps) {
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="absolute inset-0 h-full w-full border-none bg-black/70 p-0 backdrop-blur-sm cursor-default"
        onClick={onClose}
        ...
        <div className="px-6 py-8 text-center">
          ...
          <div className="mt-3 inline-block rounded-lg bg-white/5 px-4 py-2">
            <p className="text-sm font-semibold text-white">
              {product.name} <span className="font-normal text-white/40">({product.sku})</span>
            </p>
          </div>
