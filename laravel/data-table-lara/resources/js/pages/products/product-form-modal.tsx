...
import type { ModalMode, Product, ProductFormData } from './types';
import { INITIAL_FORM, PRODUCT_CATEGORIES, STATUS_OPTIONS } from './types';
  ...
  return (
    <>
      ...
      <button
        ...
        className="absolute inset-0 h-full w-full bg-black/70 backdrop-blur-sm cursor-default"
        onClick={onClose}
      />
      ...
      <div className="relative w-full max-w-xl overflow-hidden rounded-2xl border border-white/10 bg-[#0f1117] shadow-2xl shadow-black/50">
        ...
        <div className="max-h-[65vh] overflow-y-auto px-6 py-5">
          <div className="space-y-4">
            {/* Name */}
            <Field label="Nama Produk" required error={errors.name} id="name">
              <input
                id="name"
                type="text"
                value={form.name}
            ...
            <div className="grid grid-cols-2 gap-3">
              <Field label="SKU" required error={errors.sku} id="sku">
                <input
                  id="sku"
                  type="text"
                  value={form.sku}
              ...
              <Field label="Kategori" required error={errors.category} id="category">
                <select
                  id="category"
                  value={form.category}
            ...
            {/* Price + Stock */}
            <div className="grid grid-cols-2 gap-3">
              <Field label="Harga (Rp)" required error={errors.price} id="price">
                <input
                  id="price"
                  type="number"
                  value={form.price}
              ...
              <Field label="Stok" required error={errors.stock} id="stock">
                <input
                  id="stock"
                  type="number"
                  value={form.stock}
            ...
            {/* Description */}
            <Field label="Deskripsi" id="description">
              <textarea
                id="description"
...
function Field({ label, required, error, children, id }: FieldProps) {
  return (
    <div className="block">
