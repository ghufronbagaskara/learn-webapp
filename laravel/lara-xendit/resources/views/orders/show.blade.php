...
@section('content')
  ...
  @if ($order->isPending())
    ...
    @else
      @php $pendingPayment = $order->payments()->where('status', 'PENDING')->latest()->first(); @endphp
      @if ($pendingPayment)
        <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6 rounded">
          <div class="flex justify-between items-center">
            <div class="flex">
              ...
              <div class="ml-3">
                <p class="text-sm text-blue-700"><strong>Payment Invoice Ready.</strong> You can complete your
                  payment by clicking the button.</p>
              </div>
            </div>
            <div class="flex space-x-2">
              <a href="{{ $pendingPayment->invoice_url }}" target="_blank"
